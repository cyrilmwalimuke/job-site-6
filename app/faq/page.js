...
// import { Search, Users, Briefcase, Settings, HelpCircle, MessageCircle, Phone } from "lucide-react"
...
//             Find answers to common questions about our job platform. Can't find what you're looking for? We're here to
//             help!
//           </p>
...
//               <div className="mb-6">
//                 <h2 className="text-2xl font-bold mb-2">Employers</h2>
//                 <p className="text-muted-foreground">Learn how to post jobs and find the best candidates.</p>
//               </div>
//               <Accordion type="single" collapsible className="space-y-4">
//                 {faqData.employers.map((faq) => (
//                   <AccordionItem key={faq.id} value={faq.id} className="bg-white rounded-lg shadow-sm border">
//                     <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
//                       <span className="font-medium">{faq.question}</span>
//                     </AccordionTrigger>
...
//                 <p className="text-muted-foreground">Account management, payments, and platform basics.</p>
//               </div>
//               <Accordion type="single" collapsible className="space-y-4">
...
//                 <p className="text-muted-foreground">How our platform works and what makes us unique.</p>
//               </div>
//               <Accordion type="single" collapsible className="space-y-4">
//                 {faqData.platform.map((faq) => (
//                   <AccordionItem key={faq.id} value={faq.id} className="bg-white rounded-lg shadow-sm border">
//                     <AccordionTrigger className="px-6 py-4 text-left hover:no-underline">
//                       <span className="font-medium">{faq.question}</span>
//                     </AccordionTrigger>
...
//         <Card className="mt-16 bg-gradient-to-r from-orange-600 to-amber-600 text-white">
